...
export default function Auth() {
  ...
  const handleGoogleSuccess = async (credentialResponse) => {
    showLoader('Masuk dengan Google...');
                ...
                <div className={`flip-card__inner ${isRegister ? 'is-flipped' : ''}`}>
                  <div className="flip-card__front">
                    ...
                    <div className="w-full mt-2">
                      ...
                      <GoogleLoginButton onClick={handleGoogleSuccess} onError={handleGoogleError} disabled={isLoading} />
                    </div>
                  </div>
...
function GoogleLoginButton({ onClick, onError, disabled }) {
  return (
    <div className="w-full" style={{ position: 'relative' }}>
      {/* Visible styled button (underneath) */}
      <button
        type="button"
        disabled={disabled}
      ...
      {/* Invisible Google Login overlay (handles the actual OAuth) */}
      <div style={{
        position: 'absolute',
        top: 0,
        left: 0,
